...
from app.api.v1 import auth, buscar, caja, categorias, consultas, creditos, configuracion, cxc, ordenes, pacientes, presupuestos, productos, proveedores, reportes, sri, stats, tesoreria, trial_lc, turnos, usuarios, ventas, whatsapp
