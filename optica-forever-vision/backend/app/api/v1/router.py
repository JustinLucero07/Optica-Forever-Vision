...
from app.api.v1 import auth, buscar, categorias, consultas, creditos, configuracion, cxc, ordenes, pacientes, productos, reportes, sri, tesoreria, turnos, usuarios, ventas, whatsapp
